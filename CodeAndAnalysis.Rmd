...
# The ideo5 "I don't know" cases aren't really relevant to our analyses, 
...
bernHist <- bernHist + theme(plot.title = element_text(hjust = 0.5, lineheight=1, face="bold"))

bernHist <- bernHist + geom_histogram(color = "white", fill = "#154360", binwidth = 5)
bernHist
...
hrcHist <- hrcHist + theme(plot.title = element_text(hjust = 0.5, lineheight=1, face="bold"))


hrcHist <- hrcHist + geom_histogram(color = "white", fill = "#154360", binwidth = 5)
hrcHist
...
diffHist <- ggplot(data = voters, aes(diff, y= ..density..))
diffHist <- diffHist + scale_x_continuous("Point preference for Sanders")
diffHist <- diffHist + ggtitle("Difference in rating between Sanders and Clinton")
diffHist <- diffHist + theme(plot.title = element_text(hjust = 0.5, lineheight=1, face="bold"))

diffHist <- diffHist + geom_histogram(color = "white", fill = "#154360", binwidth = 5)
diffHist
...
ideoHist <- ideoHist + geom_histogram(color = "white", fill = "#154360", binwidth = 1)
ideoHist <- ideoHist + ggtitle("Histogram of self identified ideology")
ideoHist <- diffHist + theme(plot.title = element_text(hjust = 0.5, lineheight=1, face="bold"))
